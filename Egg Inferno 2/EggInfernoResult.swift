...
enum EggInfernoWebStatus: Equatable, WebStatusComparable {
    case standby
    ...
    func isEquivalent(to other: EggInfernoWebStatus) -> Bool {
        switch (self, other) {
...
extension EggInfernoWebStatus {
    static func == (lhs: EggInfernoWebStatus, rhs: EggInfernoWebStatus) -> Bool {
