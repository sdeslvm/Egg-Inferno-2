...
class EggInfernoWebCoordinator: NSObject, WKNavigationDelegate, WKUIDelegate {
    private let callback: (EggInfernoWebStatus) -> Void
    private var didStart = false

    init(onStatus: @escaping (EggInfernoWebStatus) -> Void) {
